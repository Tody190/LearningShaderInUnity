...
/*SF_DATA;ver:1.40;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,cpap:True,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:32589,y:31296,varname:node_3138,prsc:2|emission-6550-OUT;n:type:ShaderForge.SFN_Dot,id:1691,x:30849,y:31302,varname:node_1691,prsc:2,dt:0|A-253-OUT,B-4189-OUT;n:type:ShaderForge.SFN_LightVector,id:8935,x:30785,y:32259,varname:node_8935,prsc:2;n:type:ShaderForge.SFN_NormalVector,id:739,x:30469,y:32077,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:2189,x:31035,y:31302,varname:node_2189,prsc:2|A-1691-OUT,B-3425-OUT;n:type:ShaderForge.SFN_Add,id:4532,x:31213,y:31302,varname:node_4532,prsc:2|A-2189-OUT,B-3425-OUT;n:type:ShaderForge.SFN_Tex2d,id:1344,x:31582,y:31302,ptovrint:False,ptlb:RampTex,ptin:_RampTex,varname:_RampTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:410b4b6b6bbc9db4ba172003365015c7,ntxv:0,isnm:False|UVIN-512-OUT;n:type:ShaderForge.SFN_Append,id:512,x:31391,y:31302,varname:node_512,prsc:2|A-4532-OUT,B-3425-OUT;n:type:ShaderForge.SFN_Vector1,id:3425,x:31035,y:31461,varname:node_3425,prsc:2,v1:0.5;n:type:ShaderForge.SFN_Fresnel,id:9119,x:31944,y:32085,varname:node_9119,prsc:2|EXP-9077-OUT;n:type:ShaderForge.SFN_Vector1,id:9077,x:31750,y:32119,varname:node_9077,prsc:2,v1:3;n:type:ShaderForge.SFN_Multiply,id:40,x:32132,y:32196,varname:node_40,prsc:2|A-9119-OUT,B-2451-RGB;n:type:ShaderForge.SFN_Color,id:2451,x:31944,y:32303,ptovrint:False,ptlb:FresnelCol,ptin:_FresnelCol,varname:_FresnelCol,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Dot,id:892,x:31211,y:31901,varname:node_892,prsc:2,dt:0|A-3101-OUT,B-8935-OUT;n:type:ShaderForge.SFN_If,id:5393,x:31584,y:31996,varname:node_5393,prsc:2|A-892-OUT,B-5905-OUT,GT-5885-OUT,EQ-9940-OUT,LT-9940-OUT;n:type:ShaderForge.SFN_Color,id:705,x:31853,y:31541,ptovrint:False,ptlb:HightlightCol,ptin:_HightlightCol,varname:_HightlightCol,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.9079778,c2:0.9333333,c3:0.7812,c4:1;n:type:ShaderForge.SFN_Dot,id:3603,x:31190,y:31663,varname:node_3603,prsc:2,dt:0|A-2545-OUT,B-8935-OUT;n:type:ShaderForge.SFN_If,id:3782,x:31559,y:31654,varname:node_3782,prsc:2|A-3603-OUT,B-7307-OUT,GT-5885-OUT,EQ-9940-OUT,LT-9940-OUT;n:type:ShaderForge.SFN_Vector1,id:9940,x:31596,y:31540,varname:node_9940,prsc:2,v1:0;n:type:ShaderForge.SFN_Vector1,id:5885,x:31354,y:31540,varname:node_5885,prsc:2,v1:1;n:type:ShaderForge.SFN_Blend,id:6550,x:32320,y:31744,varname:node_6550,prsc:2,blmd:6,clmp:True|SRC-712-OUT,DST-40-OUT;n:type:ShaderForge.SFN_Normalize,id:2545,x:30910,y:31671,varname:node_2545,prsc:2|IN-7592-OUT;n:type:ShaderForge.SFN_Normalize,id:3101,x:30910,y:31915,varname:node_3101,prsc:2|IN-7450-OUT;n:type:ShaderForge.SFN_Vector4Property,id:7483,x:30385,y:31581,ptovrint:False,ptlb:HighlightOffset1,ptin:_HighlightOffset1,cmnt:高光偏移1,varname:_HighlightOffset1,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0,v2:0,v3:0,v4:0;n:type:ShaderForge.SFN_Vector4Property,id:637,x:30385,y:31802,ptovrint:False,ptlb:HighlightOffset2,ptin:_HighlightOffset2,cmnt:高光偏移2,varname:_HighlightOffset2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:0,v2:0,v3:0,v4:0;n:type:ShaderForge.SFN_Add,id:7592,x:30697,y:31671,cmnt:一般用Add,varname:node_7592,prsc:2|A-7483-XYZ,B-739-OUT;n:type:ShaderForge.SFN_Add,id:7450,x:30743,y:31868,varname:node_7450,prsc:2|A-637-XYZ,B-739-OUT;n:type:ShaderForge.SFN_Slider,id:7307,x:31578,y:32296,ptovrint:False,ptlb:HightlightRange1,ptin:_HightlightRange1,cmnt:高光范围1,varname:_HightlightRange1,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.6,cur:0.8,max:1;n:type:ShaderForge.SFN_Slider,id:5905,x:31223,y:32180,ptovrint:False,ptlb:HightlightRange2,ptin:_HightlightRange2,cmnt:高光范围2,varname:_HightlightRange2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.6,cur:0.8,max:1;n:type:ShaderForge.SFN_Max,id:3762,x:31773,y:31856,cmnt:用Max更好,varname:node_3762,prsc:2|A-3782-OUT,B-5393-OUT;n:type:ShaderForge.SFN_Clamp01,id:8229,x:31958,y:31856,cmnt:限制01,varname:node_8229,prsc:2|IN-3762-OUT;n:type:ShaderForge.SFN_Lerp,id:712,x:32099,y:31488,varname:node_712,prsc:2|A-1344-RGB,B-705-RGB,T-8229-OUT;n:type:ShaderForge.SFN_NormalVector,id:253,x:30668,y:31203,prsc:2,pt:False;n:type:ShaderForge.SFN_LightVector,id:4189,x:30668,y:31371,varname:node_4189,prsc:2;proporder:1344-2451-705-7483-637-7307-5905;pass:END;sub:END;*/
